...
export default function ChatInput({...props}) {
    ...
    <View style={[globalstyles.row, {flex: 1}]}>
        ...
        <View style={[globalstyles.row, {flex: 1, borderWidth: .5 && 0, borderColor: "rgba(0, 0, 0, 0.2)" && "maroon", backgroundColor: "whitesmoke", borderRadius: 20, alignSelf: "flex-start"}]}>
            <View style={[globalstyles.row, globalstyles.center, {justifyContent: "center", padding: 5, aspectRatio: 1, borderRadius: 100, borderWidth: 0, borderColor: "black", backgroundColor: "white", marginTop: 4, marginLeft: 4}]}>
                <View style={[{position: "relative", left: -0}]}>
                    <II name='attach' size={18} color={"grey"} style={[]}/>
                </View>
            </View>
            <TextInput placeholder='Type a message...' style={[{fontFamily: "GSF", fontSize: 14, alignSelf: "flex-start", paddingHorizontal: 5, height: "auto", flex: 1}]}/>
            <View style={[globalstyles.row, globalstyles.center, {justifyContent: "center", padding: 6, aspectRatio: 1, borderRadius: 100, borderWidth: 0, borderColor: "black", backgroundColor: "white", marginTop: 3.5, marginRight: 4}]}>
                <View style={[{position: "relative", left: -0}]}>
